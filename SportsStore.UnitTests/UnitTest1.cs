...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void Generate_Category_Product_Count()
        {
            ...
            int res1 = ((ProductListViewModel)target.List("Cat1").Model).PageInfo.TotalItems;
            int res2 = ((ProductListViewModel)target.List("Cat2").Model).PageInfo.TotalItems;
            int res3 = ((ProductListViewModel)target.List("Cat3").Model).PageInfo.TotalItems;
            int resAll = ((ProductListViewModel)target.List(null).Model).PageInfo.TotalItems;
